...
import configparser
from api import pandora_trading_solutions
...
def postPredict(market, ticker, horizon, predict_date):
    currentprice, predictprice, prctChange, probability = predict(market, ticker, horizon, predict_date)

    # api post
    predict_data = {'prediction': {'horizon_id': pandora_trading_solutions.gethorizonid(horizon),
                                'ticker_id': pandora_trading_solutions.get_ticker_id(ticker),
                                'created': predict_date,
    ...
    result = pandora_trading_solutions.createpredict(predict_data)
    print(predict_data)
    print(result)
    return result